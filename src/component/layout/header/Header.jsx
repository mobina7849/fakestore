      ...
      <Container>
        <div className="Header__content">
          ...
          <div className="Header__gallery">
            <div className="Header__primary_image"><img  width={"100%"} src={feature} alt="" /></div>
            <div className="Header__secondary_image_1"><img  width={"100%"}src={controller} alt="" /></div>
            <div className="Header__secondary_image_2"><img  width={"100%"}src={black_xbox} alt="" /></div>
          </div>
        </div>
      </Container>
    </header>
